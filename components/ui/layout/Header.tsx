...
export function Header() {
  ...
  return (
    <>
      <header
        ref={headerRef}
        className="shrinkingHeader pl-24 shadow-2xl flex justify-between items-center fixed w-full h-[100px] px-12 max-md:px-7 bg-white transition-all duration-500 z-50"
      >
        <Link
          href="/"
          ref={logoRef}
